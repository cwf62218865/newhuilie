...
class resume_controller extends user{
	function index_action(){
		...
		$rows=$this->obj->DB_select_all("resume_expect","`uid`='".$this->uid."' order by defaults desc","id,name,lastupdate,height_status,doc,tmpid,integrity,hits,statusbody,`topdate`,`is_entrust`,`top`,`r_status`");
	...
	function refresh_action(){
		...
		$nid?$this->layer_msg('刷新成功！',9,0):$this->layer_msg('刷新失败！',8,0);//特殊，非错误
 	}
